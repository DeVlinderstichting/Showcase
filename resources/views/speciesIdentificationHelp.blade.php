    ...
    <div class="row">
        <div class="col-md d-flex flex-column p-4">
            ...
            <ul class="list-group identification-list-group">
                <li class="list-group-item identification-list-group-item">
                    Swedish butterflies
                    <a rel="noopener noreferrer" target="_blank" class="btn btn-primary btn-sm float-end identification-section-button-list" href="https://www.vilkenart.se/Oversikt.aspx?Namn=Papilionoidea">link</a>
                </li>
                <li class="list-group-item identification-list-group-item">
                    Various
